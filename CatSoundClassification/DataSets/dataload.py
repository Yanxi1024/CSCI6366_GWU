...
class SoundDataSet(Dataset):
    """
    Initialize function:
    Input: read information (data frame format of info_data file) + dataset path
    And write relevant attributes.
    """

    def __init__(self, csv_path, data_path, max_length=None):
